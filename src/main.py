from category_strings.q1_make_parenthesis_valid.MakeParenthesisValid import MakeParenthesisValid
from category_strings.q2_is_palindrome.IsPalindrome import IsPalindrome
from category_strings.q3_is_only_unique_characters.IsOnlyUniqueCharacters import IsOnlyUniqueCharacters
from category_strings.q4_is_palindrome_permutation.IsPalindromePermutation import IsPalindromePermutation
...
q2 = IsPalindrome().test();
q3 = IsOnlyUniqueCharacters().test();
q4 = IsPalindromePermutation().test();
